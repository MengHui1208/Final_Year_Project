...
public class PublicBloodRequestAdapter extends FirestoreRecyclerAdapter<BloodRequestList, PublicBloodRequestAdapter.MyViewHolder>
{
    private OnItemClickListener listener;

    public PublicBloodRequestAdapter(@NonNull FirestoreRecyclerOptions<BloodRequestList> options) {
        super(options);
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_blood_request,parent,false);
        return new PublicBloodRequestAdapter.MyViewHolder(v);
    }
